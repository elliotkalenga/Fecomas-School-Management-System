<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="SMSWEBAPP.UBN.Login" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Umodzi Business Network -Login</title>
...
<i class="fas fa-barcode main-icon"></i>


            <h4>UMODZI BUSINESS NETWORK</h4>
            <div class="slogan">Together We Grow, Together We Prosper</div>
            ...
            <div class="center-links mt-3">
                <a href="#" data-toggle="modal" data-target="#recoverModal"><i class="fas fa-key"></i> Forget Password</a>
            </div>
