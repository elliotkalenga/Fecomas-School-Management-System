<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Students/StudentMasterPage.Master" AutoEventWireup="true" CodeBehind="FeesCollection.aspx.cs" Inherits="SMSWEBAPP.Views.Students.FeesCollection" %>
        ...
        <asp:Repeater ID="CollectionsRepeater" runat="server">
            <ItemTemplate>
                <tr class="student-row">
                    ...
                    <td>
<button t<button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#studentModal2" onclick="openEditModal('<%# Eval("FeesCollectionId") %>')">
...
<div class="modal fade" id="studentModal2" tabindex="-1" role="dialog" aria-labelledby="studentModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
<iframe id="studentIframe2" src='<%= ResolveUrl("~/Views/Admin/PrintReceipt.aspx") %>' frameborder="0"></iframe>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" id="successModal" tabindex="-1" role="dialog" aria-labelledby="successModalLabel" aria-hidden="true">
    ...
    <script>
        ...
        function openEditModal(FeesCollectionId, mode) {
            ...
            iframe.src = '<%= ResolveUrl("~/Views/Admin/PrintReceipt.aspx") %>?FeesCollectionId=' + FeesCollectionId;
        }
