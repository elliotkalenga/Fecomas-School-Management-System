<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="SMSWEBAPP.Views.Students.Login" %>
...
<body>
    ...
    <h4 class="card-title">FECOMAS SCHOOL INFORMATION MANAGEMENT SYSTEM</h4>
    <div class="slogan">Work Smarter, Efficiency Assured</div>
<div class="container-fluid">
    <div class="row" id="Mrow">
        <div class="col">
            <div class="login-form mx-auto">
                <h2 class="text-center"><i class="fas fa-sign-in-alt"></i> Student Login</h2>
            ...
            <div class="center-links mt-3">
                <a class="nav-link" href="Login.aspx"><i class="fas fa-user"></i> Student Login</a>
                <a class="nav-link" href="../Admin/UserLogin.aspx"><i class="fas fa-user-cog"></i> User Login</a>
                <a class="nav-link" href="#" data-toggle="modal" data-target="#recoverModal"><i class="fas fa-key"></i> Recover Login Details</a>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="modal-dialog modal-custom" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <iframe src="RecoverLogin.aspx" width="100%" height="500px" style="border:none;"></iframe>
            </div>
        </div>
    </div>
</div>

<!-- Bootstrap & jQuery (Ensure these are included if not already in your project) -->
