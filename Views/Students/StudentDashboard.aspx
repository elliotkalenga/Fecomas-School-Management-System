<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Students/StudentMasterPage.Master" AutoEventWireup="true" CodeBehind="StudentDashboard.aspx.cs" Inherits="SMSWEBAPP.Views.Students.StudentDashboard" %>
...
<div class="container mt-2 text-center">
    <asp:Label ID="lblBrand" runat="server" 
        Text="FECOMAS SCHOOL MANAGEMENT SYSTEM" 
        Font-Bold="true" 
        Font-Size="X-Large" 
        ForeColor="#032B44" 
        FontFamily="Arial">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-6">
                    <h4>How to Check Exam Results</h4>
                    ...
                    <ol>
                        ...
                        <a href="https://fecomas.com/Guide/HOWTOCHECKEXAMRESULTS.pdf" target="_blank" class="btn btn-secondary" download>
