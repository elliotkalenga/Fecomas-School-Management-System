<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="SmslogReport.aspx.cs" Inherits="SMSWEBAPP.Views.Admin.SmslogReport" %>
...
SMS Sent Report
                ...
                <div class="d-flex" style="margin: 0;">
                    <input type="text" id="searchInput" class="form-control mr-1" placeholder="Search for a Term..." style="height: 30px;">
                                    ...
                                    <tr class="student-row">
                                        <td>
                                            <button type="button" class="btn btn-dark-blue btn-sm" 
                                                    ...
                                                    onclick="openEditModal('<%# Eval("SentMonth") %>')">
                                                <i class="fas fa-print"></i> 
                                            </button>
                                        </td>
                                        <td><%# Eval("SentMonth") %></td>
                                        <td><%# Eval("SmsSentPerMonth") %></td>
                                        <td><%# Eval("TotalCostPerMonth") %></td>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-header d-flex justify-content-center" style="background-color: #001f3f; color: white;">
                <h5 class="modal-title text-center" id="studentModalLabel">Sms Sent Report</h5>
            ...
            <div class="modal-body">
                <iframe id="studentIframe2" src="SmsLogReportsAdd.aspx" frameborder="0" style="width: 100%; height: 500px;"></iframe>
            </div>
        </div>
    </div>
</div>
    ...
    <script>
        ...
        function confirmDelete(FeesCollectionId) {
            if (confirm("Are you sure you want to reverse this transaction?")) {
                window.location.href = 'FEnrollmentReportsAdd.aspx?Term=' + FeesCollectionId + '&mode=delete';
            }
        }
        ...
        function openEditModal(TermId, mode) {
            ...
            iframe.src = 'SmsLogReportsAdd.aspx?SentMonth=' + TermId;
        }
