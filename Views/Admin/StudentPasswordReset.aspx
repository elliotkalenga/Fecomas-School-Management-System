<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="StudentPasswordReset.aspx.cs" Inherits="SMSWEBAPP.Views.Admin.StudentPasswordReset" %>
        ...
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center" style="padding: 5px;">
                ...
                <div class="d-flex" style="margin: 0;">
                    <input type="text" id="searchInput" class="form-control mr-1" placeholder="Search for students..." style="height: 30px;">
        ...
        <asp:Repeater ID="StudentsRepeater" runat="server">
            <ItemTemplate>
                <tr class="student-row">
                    ...
                    <td><%# Eval("Status") %></td>
                    <td>
<button type="button" class="btn btn-warning btn-sm" data-toggle="modal" data-target="#studentModal" onclick="openEditModal('<%# Eval("StudentId") %>')">
    ...
    <div class="modal-dialog" role="document" style="max-width: 80%; height: 80vh;">
        <div class="modal-content" style="height: 100%;">
            <div class="modal-header">
                <h5 class="modal-title" id="studentModalLabel">Student Password Reset</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body" style="height: calc(100% - 60px); overflow-y: auto;">
                <iframe id="studentIframe" src="StudentPasswordResetAdd.aspx" style="width: 100%; height: 100%; border: none;" frameborder="0"></iframe>
            </div>
        </div>
    </div>
</div>
    ...
    <script>
        ...
        var urlParams = new URLSearchParams(window.location.search);
            ...
            if (confirm("Are you sure you want to delete this student?")) {
                window.location.href = 'StudentPasswordResetAdd.aspx?StudentID=' + studentID + '&mode=delete';
            }
        }

        function openEditModal(studentID, mode) {
            var iframe = document.getElementById('studentIframe');
            iframe.src = 'StudentPasswordResetAdd.aspx?StudentID=' + studentID;
        }
