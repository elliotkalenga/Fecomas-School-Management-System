...
{
    public partial class ResultSherrtsOthers : System.Web.UI.Page
    {
...
Order By position";
            ...
            else
            {
                ...
                ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/Reports/ResultSheetPRIOthers.rdlc");
...
(AssessmentTitle+'-'+Classname=@Assessment) Order By position";
            ...
            else
            {
                ...
                // Set the ReportViewer properties
                ReportViewer1.ProcessingMode = ProcessingMode.Local;
                ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/Reports/ResultSheetJCEOthers.rdlc");
...
";
            ...
            else
            {
                ...
                // Set the ReportViewer properties
                ReportViewer1.ProcessingMode = ProcessingMode.Local;
                ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/Reports/ResultSheetMSCEOthers.rdlc");
