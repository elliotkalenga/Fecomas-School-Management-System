<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Admin/Master.Master" AutoEventWireup="true" CodeBehind="ClassStreamAdd.aspx.cs" Inherits="SMSWEBAPP.Views.Admin.ClassStreamAdd" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container mt-3">
        <div class="form-row">
            ...
            <div class="form-group col-md-4">
                <label for="txtClassStream">Class Stream</label>
                <div class="input-group">
                    <div class="input-group-prepend">
                        <span class="input-group-text"><i class="bi bi-list-task"></i></span>
                    </div>
                    <asp:TextBox ID="txtClassStream" runat="server" CssClass="form-control" required placeholder="Enter Class Stream"></asp:TextBox>
                </div>
            </div>
        </div>
