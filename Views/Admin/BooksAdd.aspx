<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Admin/Master.Master" AutoEventWireup="true" CodeBehind="BooksAdd.aspx.cs" Inherits="SMSWEBAPP.Views.Admin.BooksAdd" %>
    ...
    <div class="form-row">
        <div class="form-group col-md-4">
            ...
            <div class="input-group">
                ...
                <asp:TextBox ID="txtBookTitle" runat="server" CssClass="form-control" placeholder="Enter Book Title"></asp:TextBox>
            </div>
        </div>
        ...
        <div class="form-group col-md-4">
            <label for="ddlBookCategory">Book Category</label>
            <div class="input-group">
                <div class="input-group-prepend">
                    <span class="input-group-text"><i class="bi bi-bookmarks"></i></span>
                </div>
                <asp:DropDownList ID="ddlBookCategory" runat="server" CssClass="form-control">
                </asp:DropDownList>
            </div>
        </div>
