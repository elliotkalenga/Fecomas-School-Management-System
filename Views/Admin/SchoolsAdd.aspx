<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Admin/Master.Master" AutoEventWireup="true" CodeBehind="SchoolsAdd.aspx.cs" Inherits="SMSWEBAPP.Views.Admin.SchoolsAdd" %>
...
<div class="container mt-3">
    <div class="form-row">
            ...
            <div class="input-group">
                ...
                <asp:TextBox ID="txtSchoolCode" runat="server" CssClass="form-control" required placeholder="Enter School Code"></asp:TextBox>
            </div>
        </div>
        ...
        <div class="form-group col-md-4">
            ...
            <div class="input-group">
                ...
                <asp:TextBox ID="txtSchoolName" runat="server" CssClass="form-control" required placeholder="Enter School Name"></asp:TextBox>
            </div>
        </div>

                <div class="form-group col-md-4">
            <label for="txtAddress">School Address</label>
            <div class="input-group">
                <div class="input-group-prepend">
                    <span class="input-group-text"><i class="bi bi-book"></i></span> 
                    <!-- Changed to 'bi-book' to represent a class -->
                </div>
                <asp:TextBox ID="txtAddress" runat="server" CssClass="form-control" required placeholder="Enter School Address"></asp:TextBox>
            </div>
        </div>
        ...
        <div class="form-group col-md-4">
            ...
            <div class="input-group">
                ...
                <asp:DropDownList ID="ddlSchoolType" runat="server" CssClass="form-control"></asp:DropDownList>
            </div>
        </div>

        <div class="form-group col-md-4">
            <label for="ddlLogo">School Logo</label>
            <div class="input-group">
                <div class="input-group-prepend">
