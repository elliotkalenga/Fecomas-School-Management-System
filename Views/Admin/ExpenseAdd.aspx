<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Admin/Master.Master" AutoEventWireup="true" CodeBehind="ExpenseAdd.aspx.cs" Inherits="SMSWEBAPP.Views.Admin.ExpenseAdd" %>
...
<div class="container mt-3">
    <div class="form-row">
        ...
        <div class="form-group col-md-12">
            <label for="txtDescription">Expense Description</label>
            <div class="input-group">
                <div class="input-group-prepend">
                    <span class="input-group-text"><i class="bi bi-ui-checks"></i></span> <!-- More indicative of selecting a purpose -->
                </div>
                <asp:TextBox ID="txtDescription" required runat="server" CssClass="form-control" placeholder="Enter Expense Description"></asp:TextBox>
            </div>
        </div>

                <div class="form-group col-md-12">
            <label for="ddlCategory">Expense Category</label>
            <div class="input-group">
                <div class="input-group-prepend">
        ...
        <div class="form-group col-md-12">
            <label for="ddlRequisition">Target Requisition</label>
            <div class="input-group">
                <div class="input-group-prepend">
                    <span class="input-group-text"><i class="bi bi-cash-stack"></i></span> 
                </div>
                <asp:DropDownList ID="ddlRequisition" runat="server" CssClass="form-control">
                </asp:DropDownList>
            </div>
        </div>
