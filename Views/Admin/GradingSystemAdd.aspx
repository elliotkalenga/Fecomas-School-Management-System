<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Admin/Master.Master" AutoEventWireup="true" CodeBehind="GradingSystemAdd.aspx.cs" Inherits="SMSWEBAPP.Views.Admin.GradingSystemAdd" %>
...
<div class="container mt-3">
    <div class="form-row">
        ...
        <div class="form-group col-md-4">
            <label for="txtLowerScale">Lower Scale</label>
            <div class="input-group">
                <div class="input-group-prepend">
                    <span class="input-group-text"><i class="bi bi-arrow-down"></i></span>
                </div>
                <asp:TextBox ID="txtLowerScale" runat="server" CssClass="form-control" required placeholder="Enter Lower Scale"></asp:TextBox>
            </div>
        </div>

        <div class="form-group col-md-4">
            <label for="txtUpperScale">Upper Scale</label>
            <div class="input-group">
                <div class="input-group-prepend">
                    <span class="input-group-text"><i class="bi bi-arrow-up"></i></span>
                </div>
                <asp:TextBox ID="txtUpperScale" runat="server" CssClass="form-control" required placeholder="Enter Upper Scale"></asp:TextBox>
            </div>
        </div>
        ...
        <div class="form-group col-md-4">
            ...
            <div class="input-group">
                ...
                <asp:TextBox ID="txtGrade" runat="server" CssClass="form-control" required placeholder="Enter Grade"></asp:TextBox>
            </div>
        </div>

        <div class="form-group col-md-4">
            <label for="txtGradeDescription">Grade Description</label>
            <div class="input-group">
                <div class="input-group-prepend">
                    <span class="input-group-text"><i class="bi bi-file-text"></i></span>
                </div>
                <asp:TextBox ID="txtGradeDescription" runat="server" CssClass="form-control" required placeholder="Enter Grade Description"></asp:TextBox>
            </div>
        </div>
        ...
        <div class="form-group col-md-4">
            ...
            <div class="input-group">
                ...
                <asp:TextBox ID="txtRemark" runat="server" CssClass="form-control" required placeholder="Enter Remark"></asp:TextBox>
            </div>
        </div>
