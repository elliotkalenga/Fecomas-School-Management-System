<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="FeesCollectionSummary.aspx.cs" Inherits="SMSWEBAPP.Views.Admin.FeesCollectionSummary" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
 ...
 Fees Collection Reports - Click on Print Icon to Start Generating
</button>
                ...
                <div class="d-flex" style="margin: 0;">
                    <input type="text" id="searchInput" class="form-control mr-1" placeholder="Search for a Student..." style="height: 30px;">
...
<button type="button" class="btn btn-dark-blue btn-sm" 
        ...
        onclick="openEditModal('<%# Eval("Term") %>')">
    <i class="fas fa-print"></i> 
                    ...
                    <td><%# Eval("Balance") %></td>
                    <td><%# Eval("CollectionPercentage") %></td>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-header d-flex justify-content-center" style="background-color: #001f3f; color: white;">
                <h5 class="modal-title text-center" id="studentModalLabel">Fees Collection Summary Reports</h5>
            ...
            <!-- Modal Body -->
            <div class="modal-body">
                <iframe id="studentIframe2" src="FeesCollectionSummaryAdd.aspx" frameborder="0" style="width: 100%; height: 500px;"></iframe>
            </div>
        </div>
    </div>
</div>
    ...
    <script>
        ...
        function confirmDelete(FeesCollectionId) {
            if (confirm("Are you sure you want to reverse this transaction?")) {
                window.location.href = 'FeesCollectionSummaryAdd.aspx?Term=' + FeesCollectionId + '&mode=delete';
            }
        }
        ...
        function openEditModal(TermId, mode) {
            ...
            iframe.src = 'FeesCollectionSummaryAdd.aspx?Term=' + TermId;
        }
