<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Admin/Master.Master" AutoEventWireup="true" CodeBehind="AssessmentScoresReports.aspx.cs" Inherits="SMSWEBAPP.Views.Admin.AssessmentScoresReports" %>
...
<div class="row">
    <div class="col-md-4">
        <label class="form-label">Continuous Assessment Results Sheet</label>
    ...
    <div class="col-md-4">
        <label class="form-label">Continuos Assessment Per Student</label>
    ...
    <div class="col-md-4">
        <label class="form-label">Aggregate Assessment Results Per Subject</label>
        ...
        <div id="loading-overlay" style="display: none; position: fixed; top: 0; left: 0; width: 100%; height: 100%; background-color: rgba(0, 0, 0, 0.5); z-index: 1000;">
            ...
            <div class="row">
            <div class="col-md-4">
                <asp:TextBox ID="txtAssessment" runat="server" CssClass="form-control mt-2" placeholder="Selected Assessment"></asp:TextBox>
            </div>
            <div class="col-md-4">
                <asp:TextBox ID="txtAssessmentStudent" runat="server" CssClass="form-control mt-2" placeholder="Selected Student"></asp:TextBox>
            </div>
            <div class="col-md-4">
                <asp:TextBox ID="txtAggregate" runat="server" CssClass="form-control mt-2" placeholder="Selected Subject"></asp:TextBox>
            </div>
        </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#<%= ddlAssessment.ClientID %>').on('select2:select', function (e) {
                showLoadingOverlay();
            });

            $('#<%= ddlAssessmentStudent.ClientID %>').on('select2:select', function (e) {
                showLoadingOverlay();
            });

            $('#<%= ddlAggregate.ClientID %>').on('select2:select', function (e) {
                showLoadingOverlay();
            });
        });
