<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Admin/Master.Master" AutoEventWireup="true" CodeBehind="IncomeAdd.aspx.cs" Inherits="SMSWEBAPP.Views.Admin.IncomeAdd" %>
    ...
    <div class="form-row">
        ...
        <div class="form-group col-md-4">
            ...
            <div class="input-group">
                ...
                <asp:TextBox ID="txtPurpose" required runat="server" CssClass="form-control" placeholder="Enter Income Purpose"></asp:TextBox>
            </div>
        </div>

        <!-- Income Description -->
        <div class="form-group col-md-6">
            <label for="txtDescription">Income Description</label>
            <div class="input-group">
                <div class="input-group-prepend">
        ...
        <div class="form-group col-md-4">
            ...
            <div class="input-group">
                ...
                <asp:TextBox ID="txtAmount" runat="server" CssClass="form-control" required placeholder="Enter Amount"></asp:TextBox>
            </div>
        </div>

        <!-- Source of Income -->
        <div class="form-group col-md-4">
            <label for="ddlSource">Source of Income</label>
            <div class="input-group">
                <div class="input-group-prepend">
