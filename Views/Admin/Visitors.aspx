<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="Visitors.aspx.cs" Inherits="SMSWEBAPP.Views.Admin.Visitors" %>
...
<div class="row">
        ...
        <asp:LinkButton ID="btnSummaryPerCategory" runat="server" CssClass="btn btn-dark-blue btn-dark-blue:hover" OnClick="btnGenerateReport_Click">
            <i class="fas fa-file-alt"></i>   Per Fees Category
        </asp:LinkButton>
    </div>

        <div class="col-md-4">
        <div class="form-group text-center ">
            <asp:Button ID="btnSubmit" runat="server" type="submit" CssClass="btn btn-dark-blue btn-dark-blue:hover btn-block" Text="Fees Collection Summary" OnClick="btnSubmit_Click" />
        </div>
    </div>
        ...
        <asp:LinkButton ID="BtnAllTransactions" runat="server" CssClass="btn btn-dark-blue btn-dark-blue:hover" OnClick="btnResultsheet_Click">
            <i class="fas fa-file-alt"></i> All Transactions
        </asp:LinkButton>
    </div>
</div>
