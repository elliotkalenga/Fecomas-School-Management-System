<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Admin/Master.Master" AutoEventWireup="true" CodeBehind="BudgetItemsAdd.aspx.cs" Inherits="SMSWEBAPP.Views.Admin.BudgetItemsAdd" %>
...
<div class="form-row">
    ...
    <div class="form-group col-md-6">
        ...
        <div class="input-group">
            ...
            <asp:TextBox ID="txtItemName" runat="server" required CssClass="form-control" placeholder="Enter Item Name"></asp:TextBox>
        </div>
    </div>

    <!-- Amount Allocated -->
    <div class="form-group col-md-6">
        <label for="txtAmount">Amount Allocated</label>
        <div class="input-group">
            <div class="input-group-prepend">
                <span class="input-group-text"><i class="bi bi-cash-stack"></i></span>
            </div>
            <asp:TextBox required ID="txtAmount" runat="server" CssClass="form-control" placeholder="Enter Amount to be allocated"></asp:TextBox>
        </div>
    </div>

    <!-- Budget Description -->
    <div class="form-group col-md-6">
        <label for="txtDescription">Notes</label>
        <div class="input-group">
            <div class="input-group-prepend">
    ...
    <!-- Budget Category -->
    <div class="form-group col-md-6">
        <label for="ddlCategory">Budget Category</label>
        <div class="input-group">
            <div class="input-group-prepend">
    ...
    <!-- Budget -->
    <div class="form-group col-md-6">
        <label for="ddlBudget">Budget</label>
        <div class="input-group">
            <div class="input-group-prepend">
