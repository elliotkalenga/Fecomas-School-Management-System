<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Admin/Master.Master" AutoEventWireup="true" CodeBehind="GradeAdd.aspx.cs" Inherits="SMSWEBAPP.Views.Admin.GradeAdd" %>
        ...
        <div class="form-row">
            <div class="form-group col-md-4">
                ...
                <div class="input-group">
                    ...
                    <asp:DropDownList ID="ddlExam" runat="server" CssClass="form-control" OnSelectedIndexChanged="ddlExam_SelectedIndexChanged"></asp:DropDownList>
                </div>
            </div>
            ...
            <div class="form-group col-md-4">
                ...
                <div class="input-group">
                    ...
                    <asp:DropDownList ID="ddlStudent" runat="server" CssClass="form-control select2"></asp:DropDownList>
                </div>
            </div>
        </div>
        ...
        <div class="form-row">
            <div class="form-group col-md-4">
                ...
                <div class="input-group">
                    ...
                    <asp:TextBox ID="txtScore" runat="server" CssClass="form-control" placeholder="Enter Score"></asp:TextBox>
                </div>
            </div>
        </div>
    </div>
