<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Admin/Master.Master" AutoEventWireup="true" CodeBehind="ExpenseApproval.aspx.cs" Inherits="SMSWEBAPP.Views.Admin.ExpenseApproval" %>
                    ...
                    <table id="studentsTable" class="table table-striped table-bordered" style="width:100%">
                        <thead>
                            <tr>
                                ...
                                <th>            <asp:TextBox ID="txtExpenseId"  ReadOnly="true" visible="false" required runat="server" CssClass="form-control" placeholder="Enter Requisition ID"></asp:TextBox>
...
<td>
    <button type="button" class="btn btn-warning btn-sm" data-toggle="modal" data-target="#studentModal" onclick="openEditModal('<%# Eval("ExpenseItemId") %>')">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="studentModalLabel">Expense Approval Management</h5>
    ...
    <script>
        ...
        function openEditModal(ExpenseId) {
            document.getElementById('studentIframe').src = 'ExpenseItemApprove.aspx?ExpenseItemId=' + ExpenseId;
        }
