<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Admin/Master.Master" AutoEventWireup="true" CodeBehind="RequisitionAdd.aspx.cs" Inherits="SMSWEBAPP.Views.Admin.RequisitionAdd" %>
    ...
    <div class="form-row">
        ...
        <div class="form-group col-md-12">
            ...
            <div class="input-group">
                ...
                <asp:TextBox ID="txtPurpose" required runat="server" CssClass="form-control" placeholder="Enter Requisition Purpose"></asp:TextBox>
            </div>
        </div>
        ...
        <div class="form-group col-md-12">
            ...
            <div class="input-group">
                <div class="input-group-prepend">
                    <span class="input-group-text"><i class="bi bi-cash-stack"></i></span> <!-- More related to financial aspects -->
                </div>
        ...
        <div class="form-group col-md-12">
            ...
            <div class="input-group">
                <div class="input-group-prepend">
                    <span class="input-group-text"><i class="bi bi-calendar-range"></i></span> <!-- Represents a term spanning a period -->
                </div>
