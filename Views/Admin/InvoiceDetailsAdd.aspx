<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Admin/Master.Master" AutoEventWireup="true" CodeBehind="InvoiceDetailsAdd.aspx.cs" Inherits="SMSWEBAPP.Views.Admin.InvoiceDetailsAdd" %>
...
<div class="container mt-3">
    <div class="form-row">
        ...
        <div class="form-group col-md-12">
            <label for="txtDescription">Invoice Description</label>
            <div class="input-group">
                <div class="input-group-prepend">
                    <span class="input-group-text"><i class="bi bi-ui-checks"></i></span> <!-- More indicative of selecting a purpose -->
                </div>
                <asp:TextBox ID="txtDescription" required runat="server" CssClass="form-control" placeholder="Enter Invoice Description"></asp:TextBox>
            </div>
        </div>

                <div class="form-group col-md-12">
            <label for="ddlSchool">Customer</label>
            <div class="input-group">
                <div class="input-group-prepend">
