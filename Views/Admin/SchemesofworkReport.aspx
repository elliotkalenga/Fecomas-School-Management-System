<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Admin/Master.Master" AutoEventWireup="true" CodeBehind="SchemesofworkReport.aspx.cs" Inherits="SMSWEBAPP.Views.Admin.SchemesofworkReport" %>
...
<div class="row">
    <div class="col-md-4">
        <label class="form-label">Generate schemes of Work Report Per Subject</label>
    ...
    <div class="col-md-4">
        <label class="form-label">Generate schemes of Work Report Per Week</label>
    ...
    <div class="col-md-4">
        <label class="form-label">Generate schemes of Work Report Per Teacher</label>
        <asp:DropDownList ID="ddlTeachers" runat="server" CssClass="form-control select2" AutoPostBack="true" OnSelectedIndexChanged="ddlTeachers_SelectedIndexChanged"></asp:DropDownList>
    </div>
</div>
        ...
        <div id="loading-overlay" style="display: none; position: fixed; top: 0; left: 0; width: 100%; height: 100%; background-color: rgba(0, 0, 0, 0.5); z-index: 1000;">
            ...
            <div class="col-md-4">
                <asp:TextBox ID="txtTeacher" runat="server" CssClass="form-control mt-2" placeholder="Selected Teacher"></asp:TextBox>
            </div>
        </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#<%= ddlTeachers.ClientID %>').on('select2:select', function (e) {
                showLoadingOverlay();
            });
        });
