<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="FeesCollectionOthers.aspx.cs" Inherits="SMSWEBAPP.Views.Admin.FeesCollectionOthers" %>
...
#studentModal2 .modal-dialog {
    ...
    height: 100vh;      /* Set the height to 85% of the viewport height */
        ...
        <asp:Repeater ID="CollectionsRepeater" runat="server">
            <ItemTemplate>
                <tr class="student-row">
                    ...
                    <td><%# Eval("CollectedDate ") %></td>
                    <td>
<button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#studentModal2" onclick="openEditModal('<%# Eval("FeesCollectionId") %>')">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="studentModalLabel">Other Fees Collection Transactions </h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <iframe id="studentIframe" src="FeesCollectionOthersAdd.aspx" frameborder="0"></iframe>
                </div>
            </div>
        </div>
    </div>
...
<div class="modal fade" id="studentModal2" tabindex="-1" role="dialog" aria-labelledby="studentModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <iframe id="studentIframe2" src="PrintReceiptOthers.aspx" frameborder="0"></iframe>
            </div>
        </div>
    </div>
</div>
    ...
    <script>
        ...
        function confirmDelete(FeesCollectionId) {
            if (confirm("Are you sure you want to reverse this transaction?")) {
                window.location.href = 'FeesCollectionOthersAdd.aspx?FeesCollectionId=' + FeesCollectionId + '&mode=delete';
            }
        }

        function openEditModal(FeesCollectionId, mode) {
            var iframe = document.getElementById('studentIframe2');
            iframe.src = 'PrintReceiptOthers.aspx?FeesCollectionId=' + FeesCollectionId;
        }
