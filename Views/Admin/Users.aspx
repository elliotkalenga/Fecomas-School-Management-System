<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="Users.aspx.cs" Inherits="SMSWEBAPP.Views.Admin.Users" %>
...
<asp:Repeater ID="RepeaterControl" runat="server">
    <ItemTemplate>
                                <tr>
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#studentModal" onclick="openEditModal('<%# Eval("UserId") %>')">
                                            <i class="fas fa-edit"></i> 
                                        </button>
                                        <button type="button" class="btn btn-danger btn-sm" onclick="confirmDelete('<%# Eval("UserId") %>')">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <iframe id="studentIframe" src="UsersAdd.aspx" frameborder="0"></iframe>
            </div>
        </div>
    </div>
</div>
    ...
    $(document).ready(function () {
        ...
        function confirmDelete(UserId) {
            if (confirm("Are you sure you want to delete this Score?")) {
                window.location.href = 'UsersAdd.aspx?UserId=' + UserId + '&mode=delete';
            }
        }

        function openEditModal(UserId, mode) {
            var iframe = document.getElementById('studentIframe');
            iframe.src = 'UsersAdd.aspx?UserId=' + UserId;
        }
