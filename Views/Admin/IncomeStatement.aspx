<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Admin/Master.Master" AutoEventWireup="true" CodeBehind="IncomeStatement.aspx.cs" Inherits="SMSWEBAPP.Views.Admin.IncomeStatement" %>
...
<div class="row">
    <div class="col-md-6">
        <asp:LinkButton ID="btnIncomeStatement" runat="server" CssClass="btn btn-dark-blue w-100" OnClick="btnIncomeStatement_Click">
            <i class="fas fa-file-alt"></i> Income Statement
        </asp:LinkButton>
    </div>
    <div class="col-md-6">
        <asp:LinkButton ID="btnBalanceSheet" runat="server" CssClass="btn btn-dark-blue w-100" OnClick="btnABalanceSheet_Click">
...
<div class="row">
    <div class="col-md-12">
        <div class="input-group">
            ...
            <asp:TextBox ID="txtExpenseId" Visible="true" runat="server" CssClass="form-control" placeholder="Term"></asp:TextBox>
