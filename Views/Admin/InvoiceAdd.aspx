<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Admin/Master.Master" AutoEventWireup="true" CodeBehind="InvoiceAdd.aspx.cs" Inherits="SMSWEBAPP.Views.Admin.InvoiceAdd" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
   ...
   <div class="form-row">
    ...
    <div class="form-group col-md-4">
        <label for="ddlFeesName">FeesName</label>
        <div class="input-group">
            <div class="input-group-prepend">
