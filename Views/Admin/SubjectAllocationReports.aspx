<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Admin/Master.Master" AutoEventWireup="true" CodeBehind="SubjectAllocationReports.aspx.cs" Inherits="SMSWEBAPP.Views.Admin.SubjectAllocationReports" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-12">
                <label class="form-label">Subject Allocation Full Report</label>
                <asp:DropDownList ID="ddlsubjectAllocation" runat="server" CssClass="form-control select2" AutoPostBack="true" OnSelectedIndexChanged="ddlAssessment_SelectedIndexChanged"></asp:DropDownList>
            </div>
<%--            <div class="col-md-4">
                <label class="form-label">MID/MOCK School Report MSCE</label>
            ...
            <div class="col-md-4">
                <label class="form-label">MID/MOCK School Report PRIMARY</label>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#<%= ddlsubjectAllocation.ClientID %>, #<%= ddlsubjectAllocation.ClientID %>, #<%= ddlsubjectAllocation.ClientID %>').on('select2:select', function () {
                showLoadingOverlay();
            });
        });
