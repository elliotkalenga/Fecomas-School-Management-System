<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="Invoices.aspx.cs" Inherits="SMSWEBAPP.Views.Admin.Invoices" %>
            ...
            <div class="card-header d-flex justify-content-between align-items-center" style="padding: 5px;">
                <div class="d-flex flex-wrap align-items-center" style="margin: 0;">
                    <button type="button" class="btn btn-dark-blue mb-1 mr-1" data-toggle="modal" data-target="#studentModal">
                        <i class="fas fa-user-plus"></i> Add New Invoice
                    </button>
        ...
        <asp:Repeater ID="StudentsRepeater" runat="server">
            <ItemTemplate>
                <tr class="student-row">
                    ...
                    <td><%# Eval("OutstandingBalance") %></td>
                    <td><%# Eval("Term") %></td>
                    <td><%# Eval("ClassName") %></td>
                    <td><%# Eval("InvoiceStatus") %></td>
                    <td>
                    <button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#studentModal" onclick="openEditModal('<%# Eval("InvoiceID") %>')">
                        <i class="fas fa-edit"></i> 
                      </button>
                        <button type="button" class="btn btn-danger btn-sm" onclick="confirmDelete('<%# Eval("InvoiceID") %>')">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="studentModalLabel">Invoices</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <iframe id="studentIframe" src="InvoiceAdd.aspx" frameborder="0"></iframe>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        var urlParams = new URLSearchParams(window.location.search);
            ...
            if (confirm("Are you sure you want to delete this student?")) {
                window.location.href = 'InvoiceAdd.aspx?InvoiceID=' + InvoiceID + '&mode=delete';
            }
        }

        function openEditModal(InvoiceID, mode) {
            var iframe = document.getElementById('studentIframe');
            iframe.src = 'InvoiceAdd.aspx?InvoiceID=' + InvoiceID;
        }
