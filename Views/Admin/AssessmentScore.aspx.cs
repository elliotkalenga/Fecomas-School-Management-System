...
{
    public partial class AssessmentScore : System.Web.UI.Page
    {
...
WHERE
    A.AssessmentStatus = 2 AND Sc.SchoolId = @SchoolId AND u.username = @Username
    AND T.Status = 2 AND a.Status = 2
ORDER BY
