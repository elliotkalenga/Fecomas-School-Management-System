<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Admin/Master.Master" AutoEventWireup="true" CodeBehind="ResultSheetsEOTReports.aspx.cs" Inherits="SMSWEBAPP.Views.Admin.ResultSheetsEOTReports" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-4">
                <label class="form-label">End of Term Result sheets (JCE)</label>
            ...
            <div class="col-md-4">
                <label class="form-label">End of Term Result Sheets (MSCE)</label>
