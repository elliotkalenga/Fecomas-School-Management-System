<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Admin/Master.Master" AutoEventWireup="true" CodeBehind="TermsAdd.aspx.cs" Inherits="SMSWEBAPP.Views.Admin.TermsAdd" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container mt-3">
        <div class="form-row">
            ...
            <div class="form-group col-md-4">
                <label for="ddlTerm">Academic Year</label>
                <div class="input-group">
                    <div class="input-group-prepend">
            ...
            <div class="form-group col-md-4">
                <label for="ddlStatus">Term Status</label>
                <div class="input-group">
                    <div class="input-group-prepend">
