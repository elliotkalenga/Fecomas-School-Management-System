<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Admin/Master.Master" AutoEventWireup="true" CodeBehind="FeesStructureAdd.aspx.cs" Inherits="SMSWEBAPP.Views.Admin.FeesStructureAdd" %>
...
<div class="container mt-3">
    <div class="form-row">
        ...
        <div class="form-group col-md-4">
            <label for="txtFeesName">Fees Name</label>
            <div class="input-group">
                <div class="input-group-prepend">
                    <span class="input-group-text"><i class="bi bi-receipt"></i></span>
                </div>
                <asp:TextBox ID="txtFeesName" runat="server" CssClass="form-control" placeholder="Enter Fees Name"></asp:TextBox>
            </div>
        </div>
