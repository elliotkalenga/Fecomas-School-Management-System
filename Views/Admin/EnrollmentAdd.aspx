<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Admin/Master.Master" AutoEventWireup="true" CodeBehind="EnrollmentAdd.aspx.cs" Inherits="SMSWEBAPP.Views.Admin.EnrollmentAdd" %>
...
<div class="form-row">
    ...
    <div class="form-group col-md-4">
        ...
        <div class="input-group">
            ...
            <asp:DropDownList ID="ddlStream" runat="server" CssClass="form-control" placeholder="Select Stream"></asp:DropDownList>
        </div>
    </div>
    <div class="form-group col-md-4">
