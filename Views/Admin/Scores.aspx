<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="Scores.aspx.cs" Inherits="SMSWEBAPP.Views.Admin.Scores" %>
...
<div class="card-header d-flex justify-content-between align-items-center p-2">
    ...
    <div class="d-flex flex-wrap gap-2">
        <div class="input-group" style="height: 30px;">
            <input type="text" id="searchInput" class="form-control" placeholder="Search for Scores...">
        </div>
    </div>
</div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <iframe id="studentIframe" src="GradeAdd.aspx" frameborder="0"></iframe>
            </div>
        </div>
    </div>
</div>
    ...
    $(document).ready(function () {
        ...
        function confirmDelete(ScoreId) {
            if (confirm("Are you sure you want to delete this Score?")) {
                window.location.href = 'GradeAdd.aspx?ScoreId=' + ScoreId + '&mode=delete';
            }
        }

        function openEditModal(ScoreId, mode) {
            var iframe = document.getElementById('studentIframe');
            iframe.src = 'GradeAdd.aspx?ScoreId=' + ScoreId;
        }
