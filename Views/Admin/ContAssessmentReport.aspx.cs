...
{
    public partial class ContAssessmentReport : System.Web.UI.Page
    {
        ...
        private void PopulateDropDownLists()
        {
            ...
            {
                string PerStudentQry = @"SELECT Distinct st.SchoolCode,T.TermId,
...
INNER JOIN 
	...
	Where st.SchoolCode=@SchoolCode order by T.TermId desc";



                string PerClassQry = @"SELECT distinct T.termid,
A.AssessmentId,
...
select distinct TermId, Assessment as AssessmentId,Assessment from Vw_endofterm where SchoolCode=@SchoolCode order by TermId desc
        ";
