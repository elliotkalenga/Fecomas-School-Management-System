<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Admin/Master.Master" AutoEventWireup="true" CodeBehind="RoomAllocationAdd.aspx.cs" Inherits="SMSWEBAPP.Views.Admin.RoomAllocationAdd" %>
...
<div class="container mt-3">
    ...
    <div class="form-group col-md-4">
        ...
        <div class="form-group col-md-4">
        <label for="ddlStudent">Room</label>
        <div class="input-group">
                    <div class="input-group">
            <div class="input-group-prepend">
                <span class="input-group-text"><i class="bi bi-search"></i></span>
            </div>
            <input type="text" id="RoomSearch" class="form-control" onkeyup="filterStudents()" placeholder="Type to search Room">
        </div>

            <div class="input-group-prepend">
                <span class="input-group-text"><i class="bi bi-door-closed"></i></span>
            </div>
            <asp:DropDownList ID="ddlRoom" runat="server" CssClass="form-control" placeholder="Select Room"></asp:DropDownList>
        </div>
    </div>


        <div class="form-group col-md-3">
            <label for="txtCondition">Room Condition</label>
            <div class="input-group">
                <div class="input-group-prepend">
                    <span class="input-group-text"><i class="bi bi-people"></i></span>
                </div>
                <asp:TextBox ID="txtCondition" runat="server" CssClass="form-control" placeholder="Enter Room Condition"></asp:TextBox>
            </div>
        </div>
