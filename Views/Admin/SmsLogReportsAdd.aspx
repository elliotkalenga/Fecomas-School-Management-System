<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Admin/Master.Master" AutoEventWireup="true" CodeBehind="SmsLogReportsAdd.aspx.cs" Inherits="SMSWEBAPP.Views.Admin.SmsLogReportsAdd" %>
...
<div class="row justify-content-center">
    <div class="col-md-12 text-center">
        <asp:LinkButton ID="btnSMSReportDetailed" runat="server" CssClass="btn btn-dark-blue btn-dark-blue:hover" OnClick="btnSMSReportDetailed_Click">
            <i class="fas fa-file-alt"></i> Sms Sent Log Report
        </asp:LinkButton>
    </div>
</div>
