<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Admin/Master.Master" AutoEventWireup="true" CodeBehind="PayInvoice.aspx.cs" Inherits="SMSWEBAPP.Views.Admin.PayInvoice" %>
...
<div class="container mt-3">
    <div class="form-row">
        ...
        <div class="form-group col-md-12">
            <label for="txtAmount">Amount to Pay</label>
            <div class="input-group">
                <div class="input-group-prepend">
                    <span class="input-group-text"><i class="bi bi-ui-checks"></i></span> <!-- More indicative of selecting a purpose -->
                </div>
                <asp:TextBox ID="txtAmount" required runat="server" CssClass="form-control" placeholder="Amount"></asp:TextBox>
            </div>
        </div>
