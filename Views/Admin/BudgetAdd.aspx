<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Admin/Master.Master" AutoEventWireup="true" CodeBehind="BudgetAdd.aspx.cs" Inherits="SMSWEBAPP.Views.Admin.BudgetAdd" %>
    ...
    <div class="form-row">
        <div class="form-group col-md-4">
            ...
            <div class="input-group">
                ...
                <asp:TextBox ID="txtBudgetName" runat="server" CssClass="form-control" placeholder="Enter Budget Name"></asp:TextBox>
            </div>
        </div>


<div class="form-group col-md-4">
    <label for="txtDescription">Budget Description</label>
    <div class="input-group">
        <div class="input-group-prepend">
            <span class="input-group-text"><i class="bi bi-book"></i></span>
        </div>
        <asp:TextBox 
            ...
            placeholder="Enter Budget Notes">
                ...
                <div class="form-group col-md-4">
            <label for="ddlTerm">Status</label>
            <div class="input-group">
                <div class="input-group-prepend">
        ...
        <div class="form-group col-md-4">
            ...
            <div class="input-group">
                ...
                <div class="form-group col-md-4">
            <label for="txtBudgetContingency">Contingency Rate</label>
            <div class="input-group">
                <div class="input-group-prepend">
                    <span class="input-group-text"><i class="bi bi-book"></i></span>
                </div>
                <asp:TextBox ID="txtContingency" runat="server" CssClass="form-control" placeholder="Enter Contingency Percentage"></asp:TextBox>
            </div>
        </div>
