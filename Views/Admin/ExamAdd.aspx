<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Admin/Master.Master" AutoEventWireup="true" CodeBehind="ExamAdd.aspx.cs" Inherits="SMSWEBAPP.Views.Admin.ExamAdd" %>
    ...
    <div class="form-row">
        <div class="form-group col-md-4">
            ...
            <div class="input-group">
                ...
                <asp:TextBox ID="txtExamCode" runat="server" CssClass="form-control" placeholder="Enter Exam Code"></asp:TextBox>
            </div>
        </div>
        <div class="form-group col-md-4">
            ...
            <div class="input-group">
                ...
                <div class="form-group col-md-4">
            <label for="txtExamWeight">Exam Weight (%)</label>
            <div class="input-group">
                <div class="input-group-prepend">
                    <span class="input-group-text"><i class="bi bi-journal-text"></i></span>
                </div>
                <asp:TextBox ID="txtExamWeight" runat="server" CssClass="form-control" placeholder="Enter Exam Weight"></asp:TextBox>
            </div>
        </div>
    </div>
    ...
    <div class="form-row">
        <div class="form-group col-md-4">
            ...
            <div class="input-group">
                ...
                <asp:DropDownList ID="ddlExamType" runat="server" CssClass="form-control"></asp:DropDownList>
            </div>
        </div>
        <div class="form-group col-md-4">
        ...
        <div class="form-group col-md-4">
            <label for="ddlExamLock">Exam Lock</label>
            <div class="input-group">
                <div class="input-group-prepend">
                    <span class="input-group-text"><i class="bi bi-lock"></i></span>
                </div>
                <asp:DropDownList ID="ddlExamLock" runat="server" CssClass="form-control"></asp:DropDownList>
            </div>
        </div>
    </div>
</div>
