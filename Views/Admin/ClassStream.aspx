<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="ClassStream.aspx.cs" Inherits="SMSWEBAPP.Views.Admin.ClassStream" %>
        ...
        <div class="card-header d-flex justify-content-between align-items-center p-2">
            <div class="d-flex flex-wrap align-items-center gap-2">
                <button type="button" class="btn btn-dark-blue mb-1" data-toggle="modal" data-target="#studentModal">
                    <i class="fas fa-user-plus"></i> Add New Class Stream Record
                </button>
            ...
            <div class="d-flex flex-wrap gap-2">
                <input type="text" id="searchInput" class="form-control" placeholder="Search for Class Stream..." style="height: 30px;">
                        ...
                        <asp:Repeater ID="RecordRepeater" runat="server">
                            <ItemTemplate>
                                <tr class="student-row">
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#studentModal" onclick="openEditModal('<%# Eval("StreamId") %>')">
                                            <i class="fas fa-edit"></i> 
                                            </td>
                                            <td>
                                        </button>
                                        <button type="button" class="btn btn-danger btn-sm" onclick="confirmDelete('<%# Eval("StreamId") %>')">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="studentModalLabel">Class Stream Management</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <iframe id="studentIframe" src="ClassStreamAdd.aspx" frameborder="0"></iframe>
            </div>
        </div>
    </div>
</div>
    ...
    <script>
        ...
        function confirmDelete(StreamId) {
            if (confirm("Are you sure you want to delete this Class Stream?")) {
                window.location.href = 'ClassStream.aspx?StreamId=' + StreamId + '&mode=delete';
            }
        }

        function openEditModal(StreamId, mode) {
            var iframe = document.getElementById('studentIframe');
            iframe.src = 'ClassStreamAdd.aspx?StreamId=' + StreamId;
        }
