<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="Roles.aspx.cs" Inherits="SMSWEBAPP.Views.Admin.Roles" %>
    ...
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center p-2">
            ...
            <div class="d-flex flex-wrap gap-2">
                <input type="text" id="searchInput" class="form-control" placeholder="Search for Roles..." style="height: 30px;">
...
<asp:Repeater ID="RepeaterControl" runat="server">
    <ItemTemplate>
                                <tr>
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#studentModal" onclick="openEditModal('<%# Eval("RoleId") %>')">
                                            <i class="fas fa-edit"></i> 
                                        </button>
                                        <button type="button" class="btn btn-danger btn-sm" onclick="confirmDelete('<%# Eval("RoleId") %>')">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="studentModalLabel">Roles Management</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <iframe id="studentIframe" src="RolesAdd.aspx" frameborder="0"></iframe>
            </div>
        </div>
    </div>
</div>
    ...
    $(document).ready(function () {
        ...
        function confirmDelete(RoleId) {
            if (confirm("Are you sure you want to delete this Score?")) {
                window.location.href = 'RolesAdd.aspx?RoleId=' + RoleId + '&mode=delete';
            }
        }

        function openEditModal(RoleId, mode) {
            var iframe = document.getElementById('studentIframe');
            iframe.src = 'RolesAdd.aspx?RoleId=' + RoleId;
        }
