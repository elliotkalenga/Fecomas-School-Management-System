<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Admin/Master.Master" AutoEventWireup="true" CodeBehind="ExamAnalysisReports.aspx.cs" Inherits="SMSWEBAPP.Views.Admin.ExamAnalysisReports" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-6">
                <label class="form-label">EXAM ANALYSIS SUMMARY REPORT (JCE)</label>
            ...
            <div class="col-md-6">
                <label class="form-label">EXAM ANALYSIS SUMMARY REPORT (MSCE)</label>
...
<%--            <div class="col-md-4">
                <label class="form-label">End of Term Result Sheets Nursary/Primary</label>
    ...
    <script>
        $(document).ready(function () {
            $('.select2').select2();
            $('#<%= ddlAssessment.ClientID %>, #<%= ddlAssessmentStudent.ClientID %>').on('select2:select', function () { showLoadingOverlay(); });
        });
