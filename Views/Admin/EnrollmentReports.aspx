<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="EnrollmentReports.aspx.cs" Inherits="SMSWEBAPP.Views.Admin.EnrollmentReports" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
 ...
 Enrollment Reports - Click on Print Icon to Start Generating
</button>
...
<div class="modal fade" id="studentModal2" tabindex="-1" role="dialog" aria-labelledby="studentModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <!-- Modal Body -->
            <div class="modal-body">
                <iframe id="studentIframe2" src="EnrollmentReportsAdd.aspx" frameborder="0" style="width: 100%; height: 500px;"></iframe>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" id="successModal" tabindex="-1" role="dialog" aria-labelledby="successModalLabel" aria-hidden="true">
    ...
    <script>
        ...
        function openEditModal(TermId, mode) {
            ...
            iframe.src = 'EnrollmentReportsAdd.aspx?Term=' + TermId;
        }
