<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="Books.aspx.cs" Inherits="SMSWEBAPP.Views.Admin.Books" %>
...
<button type="button" class="btn btn-dark-blue mb-1" data-toggle="modal" data-target="#studentModal">
    <i class="fas fa-book-medical"></i> Add New Book
                ...
                <div class="d-flex flex-wrap gap-2">
                    <input type="text" id="searchInput" class="form-control" placeholder="Search for Book..." style="height: 30px;">
                            ...
                            <asp:Repeater ID="RecordsRepeater" runat="server">
                                <ItemTemplate>
                                    <tr>
                                        ...
                                        <td>
                                            <button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#studentModal" onclick="openEditModal('<%# Eval("BookId") %>')">
                                                <i class="fas fa-edit"></i> 
                                            </button>
                                            <button type="button" class="btn btn-danger btn-sm" onclick="confirmDelete('<%# Eval("BookId") %>')">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="studentModalLabel">Books Management</h5>
                    <button type="button" class="close" data-dismiss="modal" onclick="refreshPage()" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <iframe id="studentIframe" src="BooksAdd.aspx" frameborder="0"></iframe>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        function openEditModal(BookId) {
            document.getElementById('studentIframe').src = 'BooksAdd.aspx?BookId=' + BookId;
        }

        function confirmDelete(BookId) {
            if (confirm("Are you sure you want to delete this Book?")) {
                window.location.href = 'BooksAdd.aspx?BookId=' + BookId + '&mode=delete';
            }
        }
