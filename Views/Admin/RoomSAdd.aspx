<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Admin/Master.Master" AutoEventWireup="true" CodeBehind="RoomSAdd.aspx.cs" Inherits="SMSWEBAPP.Views.Admin.RoomSAdd" %>
    ...
    <div class="form-row">
        <div class="form-group col-md-3">
            ...
            <div class="input-group">
                ...
                <asp:TextBox ID="txtRoomNumber" runat="server" CssClass="form-control" placeholder="Enter Room Number"></asp:TextBox>
            </div>
        </div>
        ...
        <div class="form-group col-md-3">
            ...
            <div class="input-group">
                ...
                <asp:TextBox ID="txtRoomDescription" runat="server" CssClass="form-control" placeholder="Enter Room Description"></asp:TextBox>
            </div>
        </div>

                <div class="form-group col-md-3">
            <label for="ddlHostel">Hostel</label>
            <div class="input-group">
                <div class="input-group-prepend">
