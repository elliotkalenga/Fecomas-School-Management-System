<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Admin/Master.Master" AutoEventWireup="true" CodeBehind="BookCategoryAdd.aspx.cs" Inherits="SMSWEBAPP.Views.Admin.BookCategoryAdd" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="form-row">
        <div class="form-group col-md-6">
            <label for="txtAssetCategory">Book Category</label>
            <div class="input-group">
                <div class="input-group-prepend">
                    <span class="input-group-text"><i class="bi bi-building"></i></span>
                </div>
                <asp:TextBox ID="txtAssetCategory" runat="server" CssClass="form-control" placeholder="Enter Book Category" Required></asp:TextBox>
            </div>
        </div>
