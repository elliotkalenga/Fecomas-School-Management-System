<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Admin/Master.Master" AutoEventWireup="true" CodeBehind="ResultSherrtsOthers.aspx.cs" Inherits="SMSWEBAPP.Views.Admin.ResultSherrtsOthers" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-4">
                <label class="form-label">MID/MOCK Result sheets (JCE)</label>
            ...
            <div class="col-md-4">
                <label class="form-label">MID/MOCK Result Sheets (MSCE)</label>
            ...
            <div class="col-md-4">
                <label class="form-label">MID/MOCK Result Sheets Nursary/Primary</label>
