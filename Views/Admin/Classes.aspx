<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="Classes.aspx.cs" Inherits="SMSWEBAPP.Views.Admin.Classes" %>
                        ...
                        <asp:Repeater ID="RecordRepeater" runat="server">
                            <ItemTemplate>
                                <tr class="student-row">
                                    ...
                                    <td><%# Eval("ScaleDescription") %></td>
                                    <td><%# Eval("Section") %></td>
                                    <td><%# Eval("ScaleType") %></td>
                                    <td><%# Eval("CreatedBy") %></td>
                                    <td><%# Eval("CreatedDateString") %></td>
                                    <td>
                                        <button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#studentModal" onclick="openEditModal('<%# Eval("ClassId") %>')">
                                            <i class="fas fa-edit"></i> 
                                        </button>
                                        <button type="button" class="btn btn-danger btn-sm" onclick="confirmDelete('<%# Eval("ClassId") %>')">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="studentModalLabel">Classes Management</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <iframe id="studentIframe" src="ClassesAdd.aspx" frameborder="0"></iframe>
            </div>
        </div>
    </div>
</div>
    ...
    <script>
        ...
        function confirmDelete(ClassId) {
            if (confirm("Are you sure you want to delete this Class?")) {
                window.location.href = 'ClassesAdd.aspx?ClassId=' + ClassId + '&mode=delete';
            }
        }

        function openEditModal(ClassId, mode) {
            var iframe = document.getElementById('studentIframe');
            iframe.src = 'ClassesAdd.aspx?ClassId=' + ClassId;
        }
