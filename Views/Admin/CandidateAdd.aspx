<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Admin/Master.Master" AutoEventWireup="true" CodeBehind="CandidateAdd.aspx.cs" Inherits="SMSWEBAPP.Views.Admin.CandidateAdd" %>
...
<div class="form-row">
    <div class="form-group col-md-4">
        ...
        <div class="input-group">
            ...
            <asp:TextBox ID="txtAddress" runat="server" CssClass="form-control" placeholder="Enter Address" AutoComplete="off" required></asp:TextBox>
        </div>
    </div>
    <div class="form-group col-md-4">
...
<div class="form-row">
    <div class="form-group col-md-4">
        ...
        <div class="input-group">
            ...
            <asp:TextBox ID="txtPassword" runat="server" TextMode="Password" CssClass="form-control" placeholder="Enter Password" AutoComplete="off" required></asp:TextBox>
        </div>
    </div>
    <div class="form-group col-md-4">
