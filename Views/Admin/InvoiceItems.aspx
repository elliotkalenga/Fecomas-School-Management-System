<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Admin/Master.Master" AutoEventWireup="true" CodeBehind="InvoiceItems.aspx.cs" Inherits="SMSWEBAPP.Views.Admin.InvoiceItems" %>
...
<div class="container mt-3">
    <div class="form-row">
            ...
            <label for="txtInvoiceId">Invoice Id</label>
            <div class="input-group">
                <div class="input-group-prepend">
                    <span class="input-group-text"><i class="bi bi-ui-checks"></i></span> 
                </div>
                <asp:TextBox ID="txtInvoiceId" required runat="server" CssClass="form-control" placeholder="InvoiceId"></asp:TextBox>
            </div>
        </div>
        ...
        <div class="form-group col-md-3">
            ...
            <div class="input-group">
                ...
                <asp:TextBox ID="txtInvoiceNumber" required runat="server" CssClass="form-control" placeholder="InvoiceNumber"></asp:TextBox>
            </div>
        </div>
            ...
            <div class="input-group">
                ...
                <asp:TextBox ID="txtItem" required runat="server" CssClass="form-control" placeholder="Enter Item"></asp:TextBox>
            </div>
        </div>


                <div class="form-group col-md-2">
            <label for="txtqunatity">Quanity</label>
            <div class="input-group">
                <div class="input-group-prepend">
                    <span class="input-group-text"><i class="bi bi-ui-checks"></i></span> 
                </div>
                <asp:TextBox ID="txtQuantity" required runat="server" CssClass="form-control" placeholder="ENter Quantity"></asp:TextBox>
            </div>
        </div>
            ...
            <div class="input-group">
                ...
                <asp:TextBox ID="txtUnitPrice" required runat="server" CssClass="form-control" placeholder="Enter Unit Price"></asp:TextBox>
            </div>
        </div>
...
<div class="card-body">
    <div class="table-responsive">
        <table id="studentsTable" class="table table-striped table-bordered" style="width:100%">
            ...
            <tbody>
                <asp:Repeater ID="RecordsRepeater" runat="server" OnItemDataBound="RecordsRepeater_ItemDataBound">
                    <ItemTemplate>
                        <tr>                            
                            <td><%# Eval("Item") %></td>
                            <td><%# Eval("Quantity") %></td>
                            <td><%# Eval("UnitPrice", "{0:N2}") %></td>
                            <td class="subtotal"><%# Eval("SubTotal", "{0:N2}") %></td>
                        </tr>
                    </ItemTemplate>
                </asp:Repeater>
            </tbody>
