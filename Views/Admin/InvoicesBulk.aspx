<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="InvoicesBulk.aspx.cs" Inherits="SMSWEBAPP.Views.Admin.InvoicesBulk" %>
            ...
            <div class="card-header d-flex justify-content-between align-items-center" style="padding: 5px;">
                <div class="d-flex flex-wrap align-items-center" style="margin: 0;">
                    <button type="button" class="btn btn-dark-blue mb-1 mr-1" data-toggle="modal" data-target="#studentModal">
                        <i class="fas fa-user-plus"></i> Create Bulk Invoices
                    </button>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="studentModalLabel">Bulk Invoices Generation</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <iframe id="studentIframe" src="InvoiceAddBulk.aspx" frameborder="0"></iframe>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        var urlParams = new URLSearchParams(window.location.search);
            ...
            if (confirm("Are you sure you want to delete this student?")) {
                window.location.href = 'InvoiceAddBulk.aspx?InvoiceID=' + InvoiceID + '&mode=delete';
            }
        }

        function openEditModal(InvoiceID, mode) {
            var iframe = document.getElementById('studentIframe');
            iframe.src = 'InvoiceAddBulk.aspx?InvoiceID=' + InvoiceID;
        }
