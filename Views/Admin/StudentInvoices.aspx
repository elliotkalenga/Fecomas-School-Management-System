<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Students/StudentMasterPage.Master" AutoEventWireup="true" CodeBehind="StudentInvoices.aspx.cs" Inherits="SMSWEBAPP.Views.Admin.StudentInvoices" %>
...
.modal-dialog {
    width: 100%;
    max-width: 90%; /* Set a maximum width for modal */
    height: 90vh; /* Full height of the viewport */
    margin: 0;
}

.modal-body {
    height: 100%; /* Ensure modal body takes full height */
    overflow-y: auto; /* Scrollable content if it overflows */
}

#studentIframe2, #studentModal2 iframe {
    width: 100%;
    height: 100%; /* Ensure iframe takes full height of the modal */
}
...
#studentModal2 .modal-body {
    height: calc(95vh - 8px); /* Adjust the body height, subtracting the header height */
...
<input type="text" id="searchInput" class="form-control" placeholder="Type any key word to Search..." style="width: 300px;">
    </div>
</div>
            </div>
            <div class="card-body">
...
<button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#studentModal2" onclick="openEditModal('<%# Eval("StudentNo") %>')">
    <i class="fas fa-print"></i> Click here to Check the details
</button>
                        </td>
                </tr>
            </ItemTemplate>
