<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Admin/Master.Master" AutoEventWireup="true" CodeBehind="AssessmentSchoolReportsOTHERS.aspx.cs" Inherits="SMSWEBAPP.Views.Admin.AssessmentSchoolReportsOTHERS" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-4">
                <label class="form-label">MID/MOCK School Report JCE</label>
        ...
        <div class="row mt-3">
            <div class="col-md-12">
                <asp:LinkButton ID="btnShare" runat="server" CssClass="btn btn-success w-100" OnClientClick="sendWhatsAppMessage('share'); return false;">
