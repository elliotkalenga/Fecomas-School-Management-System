<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Admin/Master.Master" AutoEventWireup="true" CodeBehind="LibraryInventoryAdd.aspx.cs" Inherits="SMSWEBAPP.Views.Admin.LibraryInventoryAdd" %>
...
<script>
    ...
    function filterStudents() {
        ...
        ddlStudent = document.getElementById("<%= ddlBook.ClientID %>");
   ...
   <div class="form-row">
    <div class="form-group col-md-4">
        ...
        <div class="input-group">
            ...
            <input type="text" id="studentSearch" class="form-control" onkeyup="filterStudents()" placeholder="Type to search a Book">
        </div>
            ...
            <asp:DropDownList ID="ddlBook" runat="server" CssClass="form-control" placeholder="Select Book"></asp:DropDownList>
        </div>
    </div>
    <div class="form-group col-md-4">
        <label for="ddlLocation">Library Location</label>
        <div class="input-group">
            <div class="input-group-prepend">
                <span class="input-group-text"><i class="bi bi-cash-stack"></i></span>
            </div>
            <asp:DropDownList ID="ddlLocation" runat="server" CssClass="form-control" placeholder="Select Library Location"></asp:DropDownList>
        </div>
    </div>
    ...
    <div class="input-group">
        ...
        <asp:TextBox ID="txtBarcode" runat="server" CssClass="form-control" required  placeholder="Enter or scan barcode"></asp:TextBox>
    </div>
</div>
