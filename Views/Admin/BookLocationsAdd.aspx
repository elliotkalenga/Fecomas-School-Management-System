<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Admin/Master.Master" AutoEventWireup="true" CodeBehind="BookLocationsAdd.aspx.cs" Inherits="SMSWEBAPP.Views.Admin.BookLocationsAdd" %>
...
<div class="container mt-3">
    <div class="form-row">
        <div class="form-group col-md-4">
            <label for="txtLocationName">Book Shelf Name</label>
            <div class="input-group">
                <div class="input-group-prepend">
                    <span class="input-group-text"><i class="bi bi-archive"></i></span> <!-- Changed -->
                </div>
                <asp:TextBox ID="txtLocationName" runat="server" CssClass="form-control" placeholder="Enter Shelf Name"></asp:TextBox>
            </div>
        </div>
        <div class="form-group col-md-4">
