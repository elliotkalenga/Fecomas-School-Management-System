<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Admin/Master.Master" AutoEventWireup="true" CodeBehind="AssetCategoryAdd.aspx.cs" Inherits="SMSWEBAPP.Views.Admin.AssetCategoryAdd" %>
    ...
    <div class="form-row">
        <div class="form-group col-md-6">
            ...
            <div class="input-group">
                ...
                <asp:TextBox ID="txtAssetCategory" runat="server" CssClass="form-control" placeholder="Enter Asset Category" Required></asp:TextBox>
            </div>
        </div>
