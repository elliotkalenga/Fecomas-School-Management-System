<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="Book.aspx.cs" Inherits="SMSWEBAPP.Views.Admin.Book" %>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#studentsTable').DataTable({
                ...
                "pageLength": 5, // Number of records per page (set to 5 or whatever value you prefer)
                "language": {
        ...
        function confirmDelete(BookId) {
            if (confirm("Are you sure you want to delete this Subject?")) {
                window.location.href = 'SubjectAdd.aspx?BookId=' + BookId + '&mode=delete';
            }
        }
        ...
        function openEditModal(BookId) {
            ...
            iframe.src = 'SubjectAdd.aspx?BookId=' + BookId;
        }
