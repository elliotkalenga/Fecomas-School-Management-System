<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="SMSWEBAPP.HMS.Login" %>
...
<body>
<i class="fas fa-medkit graduation-icon"></i>
    <h4 class="card-title">FECOMAS HOSPITAL MANAGEMENT SYSTEM</h4>
